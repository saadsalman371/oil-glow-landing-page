        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our hair care experts are here to help you choose the right treatment for your hair type and concerns.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@glowandco.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-green-200 shadow-sm">
                <h4 className="font-semibold text-gray-900 mb-4">Quick Order</h4>
                <p className="text-gray-600 mb-4">Ready to order? Call us directly for fastest service!</p>
